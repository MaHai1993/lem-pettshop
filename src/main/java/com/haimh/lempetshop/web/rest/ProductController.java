...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDTO>> getAllOrder(Pageable pageable) {
    ...
    @PostMapping("/create")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<ProductDTO> createOrder(@Valid @RequestBody ProductDTO productDTO) {
